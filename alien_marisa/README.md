...
> 依赖版本在 `gradle.properties`：Minecraft `1.21.1`、NeoForge `21.1.154`、ModDev Plugin `2.0.143`。
...
2. `/alienmarisa list` —— 看她学会了什么（含类型、弹速、距离、使用次数）
3. `/alienmarisa last` / `random` / `replay <n>` —— 她还给你（在你正前方生成，弹道与你当时完全一致）
4. `/alienmarisa canhit` —— 只放**此刻真能打中你**的招（压迫感核心）
